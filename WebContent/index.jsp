  ...
  <c:forEach items="${clientlist }" var="list">
    <tr>
     ...
     <td>
     	...
     	<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#${ list.idCustomer}" aria-expanded="false" aria-controls="id" name="edit" value="${list.idCustomer }"    >
 Edit
  
</button>
 
     
			<input type="hidden" name="clientID" value="${list.idCustomer }" />	
  ...
  <div class="well">
			...
			<div class="bs-docs-grid">
								<div class="row show-grid">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="uploadFile">Upload File</label> <input
							...
							<div class="bs-docs-grid">
								<div class="row show-grid">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<label for="house">House Number:</label> <input type="text"
												class="form-control" id="uphouse" value="${client.houseNumber }"
												name="uphousenumber">
										</div>
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<label for="uptelephone">Telephone:</label> <input type="text"
												class="form-control" id="upTelephone" value="${client.telephone }"
												name="uptelephone">
										</div>
							...
							<div class="bs-docs-grid">
								<div class="row show-grid">
									...
									<div class="col-md-1">
										<button class="btn btn-md btn-primary" type="reset"
											 name="upcancel" data-toggle="collapse" data-target="#${client.idCustomer }"> Cancel </button>
									</div>
									<div class="col-md-1">
									
									 <input type="hidden" name="idClient123" value="${client.idCustomer }" />
										<input class="btn btn-md btn-primary" type="submit"
